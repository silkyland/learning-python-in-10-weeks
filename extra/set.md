...
1. จงเขียนโปรแกรมที่รับข้อความ (string) จากผู้ใช้ จากนั้นให้ตรวจสอบว่าข้อความนั้นมีตัวอักษรที่ไม่ซ้ำกันกี่ตัว

2. จงเขียนโปรแกรมที่รับ List ของตัวเลขจากผู้ใช้ จากนั้นให้ตรวจสอบว่ามีตัวเลขใดบ้างที่ปรากฏมากกว่าหนึ่งครั้งใน List นั้น และแสดงผลลัพธ์เป็น Set ของตัวเลขที่ซ้ำกัน

3. จงเขียนโปรแกรมที่รับ Set สองชุดจากผู้ใช้ จากนั้นให้หาและแสดงผล:

   - จำนวนสมาชิกที่เหมือนกันใน Set ทั้งสอง
   - จำนวนสมาชิกที่แตกต่างกันใน Set ทั้งสอง
   - สมาชิกที่ปรากฏใน Set ใดSet หนึ่ง แต่ไม่ได้ปรากฏในอีก Set หนึ่ง

4. จงเขียนโปรแกรมที่รับ List ของ String จากผู้ใช้ จากนั้นให้สร้าง Set ที่เก็บเฉพาะ String ที่มีความยาวมากกว่า 5 ตัวอักษร โดยใช้ Set Comprehension

5. จงเขียนโปรแกรมที่รับ Dictionary ที่มี Key เป็นชื่อของบุคคล และ Value เป็น Set ของหมายเลขโทรศัพท์ของบุคคลนั้น จากนั้นให้ทำการ:
   - เพิ่มหมายเลขโทรศัพท์ใหม่ให้กับบุคคลที่ต้องการ
   - ลบหมายเลขโทรศัพท์ของบุคคลที่ต้องการ
   - ตรวจสอบว่าหมายเลขโทรศัพท์ที่กำหนดเป็นของบุคคลใด
   - แสดง Dictionary ของบุคคลและหมายเลขโทรศัพท์ทั้งหมด
